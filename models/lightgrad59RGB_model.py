...
class lightgrad59RGBModel(BaseModel):
    def name(self):
        return 'lightgrad59RGBModel'
    ...
    def set_input(self, input):
        ...
        # self.real_A = input['A_con'].to(self.device)
    ...
    def forward(self, epoch):
        ...
        if epoch <= 10:
            #TODO:::::::::::::: just_temp train with all connected::::::::::::::::::::::::
            self.fake_B, _, self.fake_AL, _ = self.netG(self.real_A, self.real_BL, 0, oriImg=None)
