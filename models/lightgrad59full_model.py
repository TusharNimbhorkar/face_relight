...
class lightgrad59fullModel(BaseModel):
    def name(self):
        return 'lightgrad59fullModel'
    ...
    def __init__(self, opt):
        ...
        # my_network_512.load_state_dict(torch.load(os.path.join(opt.ft_model)))

        self.netG = HourglassNet_1024(my_network_512, 16).to(self.device)
