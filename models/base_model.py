        ...
        for name in self.model_names:
            if isinstance(name, str):
                ...
                if len(self.gpu_ids) > 0 and torch.cuda.is_available():
                    ...
                    if (name=='G' or name=='G1') and (self.opt.model=='light' or self.opt.model=='lightgrad' or self.opt.model=='lightft' or self.opt.model=='lightgrad57'or self.opt.model=='lightgrad51'or self.opt.model=='lightgrad52'or self.opt.model=='lightgrad53'or self.opt.model=='lightgrad54' or self.opt.model=='lightgrad55'):
