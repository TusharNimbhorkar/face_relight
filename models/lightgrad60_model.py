...
class lightgrad60Model(BaseModel):
    def name(self):
        return 'lightgrad60Model'
    ...
    def backward_G(self, epoch):
        ...
        # Second, G(A) = B
        self.loss_G_L1 = self.criterionL1(self.S*self.real_B, self.S*self.fake_B)  # * self.opt.lambda_L1
