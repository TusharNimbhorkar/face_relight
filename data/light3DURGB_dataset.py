...
class light3DURGBDataset(BaseDataset):
    @staticmethod
    ...
    def __init__(self, opt):
        ...
        self.AB_paths_ = make_dataset(self.dir_AB, n_per_id)
        self.AB_paths = []
        self.dict_AB = {}
        self.list_AB = []
    ...
    def get_item_path(self, path, fname_pattern):
    ...
    def __getitem__(self, index):
        ...
        segment_path = os.path.join(self.opt.dataroot,'segments',AB_path[0].split('/')[-2],AB_path[0].split('/')[-2]+'.png')
        # print(segment_path)
        ...
        orig_im_path = target_path.rsplit('/',1)[0] + '/orig.png'
        ...
        # TODO: LIGHT!!!!!
        AL_path = self.get_item_path(AB_path[0], 'light_%s_sh.txt')
        ...
        BL_path = self.get_item_path(target_path, 'light_%s_sh.txt')
