'''
    this is a simple test file for calculating rmse on segments of MULTIPIE. BATCH PROCESSING( multiple resolution)
'''
...
test_dirs = ['/home/tushar/face_relight/substet_eval/transfer_batch_2x','/home/tushar/face_relight/substet_eval/transfer_batch_fullres']
...
for test_dir in test_dirs:
    ...
    for per in persons:
        if per in old_people:
            ...
            # from
            side_im = os.path.join(person_dir, per + '_04.png')
            # To
