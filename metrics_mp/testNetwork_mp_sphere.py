    ...
    if per in old_people:
        ...
        if os.path.exists(side_im) and os.path.exists(front_im):
            ...
            for sh_v in sh_vals:
                ...
                if sh_v == '07':
                    sh_constant = 0.6 #best one
                    # sh_constant = 0.82 #best one


                # side_im = '/home/tushar/face_relight/mp_subset/side/epoch014_real_A.png'
                # front_im = '/home/tushar/face_relight/mp_subset/front/epoch014_real_B.png'But
                ...
                for i in range(1):
                    sh = np.loadtxt('00/rotate_light_11.txt')
                    sh = sh[0:9]
                    sh = sh * sh_constant
                    # --------------------------------------------------
                    ...
                    outputImg, _, _, _ = my_network(inputL, sh, skip_c)
                    ...
                    cv2.imwrite(os.path.join('10_07.jpg'.format(i)), resultLab)
