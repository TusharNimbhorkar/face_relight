...
class Model:
    ...
    def __call__(self, input_img, target_sh, *args, **kwargs):
        ...
        if len(self.model)>0:
            model_output = self.model[0](torch_input_img, target_sh, *args)
            output_img_neutral, _, output_sh, _ = model_output
            model_output = self.model[1](output_img_neutral, target_sh, *args)
            output_img_rel, _, _, _ = model_output
            output_img = []
            output_img.append(output_to_img(output_img_neutral, self.input_mode, input_img=input_img))
            output_img.append(output_to_img(output_img_rel, self.input_mode, input_img=input_img))
...
model_lab_stylegan_031_256_10k_neut_facetone_pcrop = Model('/home/tushar/data1/project/face_relight/outputs/model_256_10k_lab_0.3.1_70kffhq_facetone/14_net_G.pth', input_mode='LAB', resolution=256, ambience=0.280, nc_sh=1, dataset_name='3dulight_shfix2', name='L+AB sGAN v0.3.1 256\n10k int=0, Neut, Facetone', intensity=0, enable_neutral=True, enable_face_tone=True)
model_lab_stylegan_031_256_10k_neut_facetone_pcrop_reproducible = Model('/home/tushar/data1/project/face_relight/outputs/model_256_10k_lab_0.3.1_facetone_reproducible/14_net_G.pth', input_mode='LAB', resolution=256, ambience=0.280, nc_sh=1, dataset_name='3dulight_shfix2', name='L+AB sGAN v0.3.1 256 10k  \n Facetone_reproducible', intensity=0, enable_neutral=True, enable_face_tone=True)

model_lab_stylegan_031_256_10k_neut_facetone_pcrop_70k_70k = Model('/home/tushar/data1/project/face_relight/outputs/model_256_10k_lab_0.3.1_facetone_70k_70k/14_net_G.pth', input_mode='LAB', resolution=256, ambience=0.280, nc_sh=1, dataset_name='3dulight_shfix2', name='L+AB sGAN 10k v0.3.1 256\n 70k+70k Facetone', intensity=0, enable_neutral=True, enable_face_tone=True)
model_lab_stylegan_031_256_30k_neut_facetone_pcrop_30k_30k = Model('/home/tushar/data1/project/face_relight/outputs/model_256_30k_lab_0.3.1_30kffhq_30ksgan_facetone/14_net_G.pth', input_mode='LAB', resolution=256, ambience=0.280, nc_sh=1, dataset_name='3dulight_shfix2', name='L+AB sGAN 30k v0.3.1 256\n 30k+30k Facetone', intensity=0, enable_neutral=True, enable_face_tone=True)
model_lab_stylegan_031_256_30k_neut_pcrop_70k_70k = Model(outputs_path_tushar_ds3 + 'model_256_30k_lab_0.3.1_70ksgan_70kffhq/14_net_G.pth', input_mode='LAB', resolution=256, ambience=0.280, nc_sh=1, dataset_name='3dulight_shfix2', name='lab_stgan_30k_031_256  \n D: 70k+70k ', intensity=0, enable_neutral=True)

model_lab_stylegan_031_256_10k_neut_pcrop_bs19_bs15 = Model(outputs_path_tushar_ds3 + 'model_256_lab_stylegan_0.3.1_10k_neutral_amb_pcrop/14_net_G.pth', input_mode='LAB', resolution=256, ambience=0.280, nc_sh=1, dataset_name='3dulight_shfix2', name='model_lab_stylegan_031_256_10k_neut  \nBS19_15 70k ffhq', intensity=0, enable_neutral=True)
model_lab_stylegan_031_256_10k_neut_pcrop_bs15 = Model(outputs_path_tushar_ds3 + 'model_256_lab_stylegan_0.3.1_10k_neutral_amb_pcrop_bs15/14_net_G.pth', input_mode='LAB', resolution=256, ambience=0.280, nc_sh=1, dataset_name='3dulight_shfix2', name='model_lab_stylegan_031_256_10k_neut  \nBS15 70k ffhq', intensity=0, enable_neutral=True)


model_lab_stylegan_031_256_10k_neut_pcrop_30k_30k = Model(outputs_path_tushar_ds3 + 'stylegan_v031_10k_ambient_pcrop_256_30k_30k/14_net_G.pth', input_mode='LAB', resolution=256, ambience=0.280, nc_sh=1, dataset_name='3dulight_shfix2', name='model_lab_stylegan_031_256_10k_neut  \n 30k+30k', intensity=0, enable_neutral=True)
model_lab_stylegan_031_256_30k_neut_pcrop_30k_30k = Model(outputs_path_tushar_ds3 + 'stylegan_v031_30k_ambient_pcrop_256_30k_30k/14_net_G.pth', input_mode='LAB', resolution=256, ambience=0.280, nc_sh=1, dataset_name='3dulight_shfix2', name='model_lab_stylegan_031_256_30k_neut  \n 30k+30k', intensity=0, enable_neutral=True)


# relight model
# model_lab_stylegan_v010_0_1024_256_relight = Model(outputs_path_tushar_ds3 + '/stylegan_v010_0_1024_256_relight/14_net_G.pth', input_mode='LAB', resolution=256, ambience=None, nc_sh=1, dataset_name='3dulight_shfix2', name='model_lab_/stylegan_v010_0_1024_256_relight 30k \n 30k+30k', intensity=0,enable_amb_color=True) #enable_neutral=True)
model_lab_stylegan_v010_0_1024_256_relight = Model(outputs_path_tushar_ds3 + '/stylegan_v010_0_1024_256_relight/14_net_G.pth', input_mode='LAB', resolution=256, ambience=None, nc_sh=1, dataset_name='3dulight_shfix2', name='model_lab_/stylegan_v010_0_1024_256_relight 30k \n 30k+30k', intensity=0,enable_amb_color=True) #enable_neutral=True)
model_lab_stylegan_v010_0_20k_256_relight = Model(outputs_path_tushar_ds3 + '/stylegan_v010_0_256_relight_20k_rmix30k_30k/14_net_G.pth', input_mode='LAB', resolution=256, ambience=None, nc_sh=1, dataset_name='3dulight_shfix2', name='model_lab_stylegan_v010_0_relight G:20k \n 30k+30k', intensity=0,enable_amb_color=True) #enable_neutral=True)

# with non-front
stylegan_v010_1_256_relight_10k_rmix30k_30k_onlynonfront = Model(outputs_path_tushar_ds3 + '/stylegan_v010_1_256_relight_10k_rmix30k_30k/14_net_G.pth', input_mode='LAB', resolution=256, ambience=None, nc_sh=1, dataset_name='3dulight_shfix2', name='model_relight G:10k NF \n 30k+30k', intensity=0,enable_amb_color=True) #enable_neutral=True)
stylegan_v010_3_256_relight_20k_rmix30k_30k_mix = Model(outputs_path_tushar_ds3 + '/stylegan_v010_3_256_relight_20k_rmix30k_30k/14_net_G.pth', input_mode='LAB', resolution=256, ambience=None, nc_sh=1, dataset_name='3dulight_shfix2', name='model_relight G:20k NF+F\n 30k+30k', intensity=0,enable_amb_color=True) #enable_neutral=True)

stylegan_v010_3_256_relight_50k_70kffhq = Model(outputs_path_tushar_ds3 + '/stylegan_v010_3_256_relight_50k_70kffhq/14_net_G.pth', input_mode='LAB', resolution=256, ambience=None, nc_sh=1, dataset_name='3dulight_shfix2', name='model_relight G:50k \n FFHQ:70k', intensity=0,enable_amb_color=True) #enable_neutral=True)
stylegan_v010_3_256_relight_50k_rmix50k_50k = Model(outputs_path_tushar_ds3 + '/stylegan_v010_3_256_relight_50k_rmix50k_50k/14_net_G.pth', input_mode='LAB', resolution=256, ambience=None, nc_sh=1, dataset_name='3dulight_shfix2', name='model_relight G:50k \n 50k+50k', intensity=0,enable_amb_color=True) #enable_neutral=True)

stylegan_end2end_relight_50k_rmix50k_30k = Model('outputs/end2end_50k_031_256_rmix30k/14_net_G1.pth', input_mode='LAB', resolution=256, ambience=0.280, nc_sh=1, dataset_name='3dulight_shfix2', name='E2E: model_relight G:50k \n rmix30k', intensity=0)#, enable_neutral=True)
stylegan_end2end_relight_50k_rmix50k_50k = Model('outputs/end2end_50k_031_256_rmix50k/14_net_G1.pth', input_mode='LAB', resolution=256, ambience=0.280, nc_sh=1, dataset_name='3dulight_shfix2', name='E2E: model_relight G:50k \n rmix40k', intensity=0)#, enable_neutral=True)
end2end_50k_031_256_rmix50k_D2_data_70kFFHQ = Model('outputs/end2end_50k_031_256_rmix50k_D2_data_70kFFHQ/14_net_G1.pth', input_mode='LAB', resolution=256, ambience=0.280, nc_sh=1, dataset_name='3dulight_shfix2', name='E2E: model_relight G:50k \n D1:rmix50k D2:70k ffhq', intensity=0)#, enable_neutral=True)



# stylegan_v010_1_256_relight_10k_rmix30k_30k_onlynonfront, stylegan_v010_3_256_relight_20k_rmix30k_30k_mix


# 'model_256_lab_stylegan_0.3.1_10k_neutral_amb_pcrop'
...
model_lab_stylegan_031_256_10k_neut_ft21_pcrop = Model(outputs_path + 'model_256_l_stylegan_0.3.1_10k_neutral_amb_pcrop/21_net_G.pth', input_mode='LAB', resolution=256, ambience=0.280, nc_sh=1, dataset_name='3dulight_shfix2', name='L+AB sGAN v0.3.1 256\n10k int=0, Neut, ft 21ep', intensity=0, enable_neutral=True)
model_lab_stylegan_031_256_10k_neut_ft22_pcrop = Model(outputs_path + 'model_256_l_stylegan_0.3.1_10k_neutral_amb_pcrop/22_net_G.pth', input_mode='LAB', resolution=256, ambience=0.280, nc_sh=1, dataset_name='3dulight_shfix2', name='L+AB sGAN v0.3.1 256\n10k int=0, Neut, ft 22ep', intensity=0, enable_neutral=True)
model_lab_stylegan_031_256_10k_neut_ft15_pcrop = Model(outputs_path + 'model_256_l_stylegan_0.3.1_10k_neutral_amb_pcrop/15_net_G.pth', input_mode='LAB', resolution=256, ambience=0.280, nc_sh=1, dataset_name='3dulight_shfix2', name='L+AB sGAN v0.3.1 256\n10k int=0, Neut, ft 15ep', intensity=0, enable_neutral=True)
model_lab_stylegan_031_256_10k_neut_ft17_pcrop = Model(outputs_path + 'model_256_l_stylegan_0.3.1_10k_neutral_amb_pcrop/17_net_G.pth', input_mode='LAB', resolution=256, ambience=0.280, nc_sh=1, dataset_name='3dulight_shfix2', name='L+AB sGAN v0.3.1 256\n10k int=0, Neut, ft 17ep', intensity=0, enable_neutral=True)
model_lab_stylegan_031_256_10k_neut_ft20_pcrop = Model(outputs_path + 'model_256_l_stylegan_0.3.1_10k_neutral_amb_pcrop/20_net_G.pth', input_mode='LAB', resolution=256, ambience=0.280, nc_sh=1, dataset_name='3dulight_shfix2', name='L+AB sGAN v0.3.1 256\n10k int=0, Neut, ft 20ep', intensity=0, enable_neutral=True)
model_lab_stylegan_031_256_10k_neut_ft23_pcrop = Model(outputs_path + 'model_256_l_stylegan_0.3.1_10k_neutral_amb_pcrop/23_net_G.pth', input_mode='LAB', resolution=256, ambience=0.280, nc_sh=1, dataset_name='3dulight_shfix2', name='L+AB sGAN v0.3.1 256\n10k int=0, Neut, ft 23ep', intensity=0, enable_neutral=True)

# doesnt have any sgan v01 data
model_lab_stylegan_031_256_10k_neutral_sideoffset_70ksgan_70kffhq = Model(outputs_path_tushar_ds3 + 'model_256_10k_lab_0.3.1_70ksgan_70kffhq/14_net_G.pth', input_mode='LAB', resolution=256, ambience=0.280, nc_sh=1, dataset_name='3dulight_shfix2', name='lab_sgan_10k_031_256 \n D: 70k+70k', intensity=0, enable_neutral=True)
model_lab_stylegan_031_256_10k_neutral_sideoffset_70ksgan_70kffhq_13th_epoch = Model(outputs_path_tushar_ds3 + 'model_256_10k_lab_0.3.1_70ksgan_70kffhq/13_net_G.pth', input_mode='LAB', resolution=256, ambience=0.280, nc_sh=1, dataset_name='3dulight_shfix2', name='ep:13 lab_sgan_10k_031_256 \n D: 70k+70k', intensity=0, enable_neutral=True)
model_lab_stylegan_031_256_10k_neutral_sideoffset_30ksgan_30kffhq = Model(outputs_path_tushar_ds3 + 'model_256_10k_lab_0.3.1_sideoffsetcrop_30ksgan_30kffhq/14_net_G.pth', input_mode='LAB', resolution=256, ambience=0.280, nc_sh=1, dataset_name='3dulight_shfix2', name='lab_sgan_10k_031_256_neutral \n 30ksgan_30kffhq', intensity=0, enable_neutral=True)


model_lab_stylegan_031_256_10k_neutral_sideoffset_60ksgan_60kffhq = Model(outputs_path_tushar_ds3 + 'model_256_10k_lab_0.3.1_sideoffsetcrop_60ksgan_60kffhq/14_net_G.pth', input_mode='LAB', resolution=256, ambience=0.280, nc_sh=1, dataset_name='3dulight_shfix2', name='model_lab_stylegan_031_256_10k_neutral \n 60ksgan_60kffhq', intensity=0, enable_neutral=True)

# lchannel loss
model_lab_stylegan_031_256_10k_neutral_sideoffset_70kffhq_LchannelLoss = Model(outputs_path_tushar_ds3 + 'model_256_10k_lab_0.3.1_70kffhq_LchannelLoss/14_net_G.pth', input_mode='LAB', resolution=256, ambience=0.280, nc_sh=1, dataset_name='3dulight_shfix2', name='model_lab_stylegan_031_256_10k_ \n 70kffhq_LchannelLoss', intensity=0, enable_neutral=True)
...
model_lab_stylegan_031_256_10k_neut_pcrop = Model(outputs_path + 'model_256_lab_stylegan_0.3.1_10k_neutral_amb_pcrop/14_net_G.pth', input_mode='LAB', resolution=256, ambience=0.280, nc_sh=1, dataset_name='3dulight_shfix2', name='lab_sgan_10k_031_256 \n 70k ffhq', intensity=0, enable_neutral=True)
...
model_512_lab_stylegan_052_30k_r70kffhq_neutral_noprops_pcrop = Model(outputs_path_tushar_ds3 + 'model_512_lab_stylegan_0.5.2_30k_r70kffhq_neutral_noprops_pcrop/14_net_G.pth', input_mode='LAB', resolution=512, ambience=None, nc_sh=1, dataset_name='3dulight_shfix2', name='L+AB 30k sGAN v0.5.2 512\n D:70k ffhq', intensity=0, enable_neutral=True, enable_amb_color=True)
model_512_lab_stylegan_052_30k_r30kffhq_30ksgan_neutral_noprops_pcrop = Model(outputs_path_tushar_ds3 + 'model_512_lab_stylegan_0.5.2_30k_r30k+30k_neutral_noprops_pcrop/14_net_G.pth', input_mode='LAB', resolution=512, ambience=None, nc_sh=1, dataset_name='3dulight_shfix2', name='L+AB 30k sGAN v0.5.2 512\n D:30k ffhq, 30k SGAN', intensity=0, enable_neutral=True, enable_amb_color=True)

model_512_lab_stylegan_052_20k_r30k_30k_neutral_noprops_pcrop = Model(outputs_path_tushar_ds3 + 'model_512_lab_stylegan_0.5.2_20k_r30k+30k_neutral_noprops_pcrop/14_net_G.pth', input_mode='LAB', resolution=512, ambience=None, nc_sh=1, dataset_name='3dulight_shfix2', name='L+AB 20k sGAN v0.5.2 512\n D:30k ffhq, 30k SGAN', intensity=0, enable_neutral=True, enable_amb_color=True)
...
model_lab_stylegan_052_256_30k_neut_pcrop_rmix30k = Model(outputs_path + 'model_256_lab_stylegan_0.5.2_30k_r30k+30k_neutral_pcrop/14_net_G.pth', input_mode='LAB', resolution=256, ambience=None, nc_sh=1, dataset_name='3dulight_shfix2', name='L+AB 30k sGAN v0.5.2 256\n D: rmix30k, pcrop', intensity=0, enable_neutral=True, enable_amb_color=True)
model_lab_stylegan_052_256_10k_neut_ambcolor_pcrop = Model(outputs_path + 'model_256_lab_stylegan_0.5.2_10k_neutral_ambcolor_allprops_pcrop/14_net_G.pth', input_mode='LAB', resolution=256, ambience=None, nc_sh=1, dataset_name='3dulight_shfix2', name='L+AB sGAN v0.5.2 256\n10k D:70k ffhq', intensity=0, enable_neutral=True, enable_amb_color=True)

# model_lab_stylegan_052_256_10k_neut_ambcolor_pcrop,model_lab_stylegan_052_256_30k_neut_pcrop,model_lab_stylegan_052_256_30k_neut_pcrop_rmix30k

# 512
model_512_10k_lab_031_30ksgan_30kffhq = Model(outputs_path_tushar_ds3 + 'model_512_10k_lab_0.3.1_30ksgan_30kffhq/14_net_G.pth', input_mode='LAB', resolution=512, ambience=0.280, nc_sh=1, dataset_name='3dulight_shfix2', name='model_512_10k_lab_031 \n D: rmix30k, pcrop', intensity=0, enable_neutral=True)
model_512_30k_lab_031_30ksgan_30kffhq = Model(outputs_path_tushar_ds3 + 'model_512_30k_lab_0.3.1_30ksgan_30kffhq/14_net_G.pth', input_mode='LAB', resolution=512, ambience=0.280, nc_sh=1, dataset_name='3dulight_shfix2', name='model_512_30k_lab_031 \n D: rmix30k, pcrop', intensity=0, enable_neutral=True)
...
#
# model_256_lab_stylegan_031_30k_neutral_pcrop_r30k_r30k, model_256_lab_stylegan_031_30k_neutral_pcrop_r50k_r50k, model_256_lab_stylegan_031_30k_neutral_pcrop_r70k_r70k
#
# model_256_lab_stylegan_031_50k_neutral_pcrop_r30k_r30k, model_256_lab_stylegan_031_50k_neutral_pcrop_r50k_r50k , model_256_lab_stylegan_031_50k_neutral_pcrop_r70k_r70k

# outputs_path + 'model_256_lab_stylegan_0.3.1_30k_neutral_pcrop_r30k+r30k'
# outputs_path_tushar_ds3 + 'model_256_lab_stylegan_0.3.1_30k_neutral_amb_pcrop_r50k+50k'
# outputs_path_tushar_ds3 + 'model_256_lab_stylegan_0.3.1_30k_neutral_amb_pcrop_r70k+70k'

# outputs_path_tushar_ds3 + 'model_256_lab_stylegan_0.3.1_50k_neutral_amb_pcrop_r30k+30k'
# outputs_path_tushar_ds3 + 'model_256_lab_stylegan_0.3.1_50k_neutral_amb_pcrop_r50k+50k'
# outputs_path_tushar_ds3 + 'model_256_lab_stylegan_0.3.1_50k_neutral_amb_pcrop_r70k+70k'
...
#     model_lab_stylegan_031_256_10k_neutral_sideoffset_70ksgan_70kffhq,
# model_lab_stylegan_031_256_10k_neutral_sideoffset_70ksgan_70kffhq_13th_epoch,
# model_lab_stylegan_031_256_10k_neutral_sideoffset_30ksgan_30kffhq,
#     model_lab_stylegan_031_256_30k_neut_pcrop_70k_70k,

# model_lab_stylegan_031_256_10k_neut_pcrop_bs19_bs15,
# model_lab_stylegan_031_256_10k_neut_pcrop_bs15
# model_lab_stylegan_031_256_10k_neut_pcrop_30k_30k,
# model_lab_stylegan_031_256_30k_neut_pcrop_30k_30k,

#####  best relight #####
# model_lab_stylegan_v010_0_1024_256_relight
# model_lab_stylegan_v010_0_20k_256_relight,
# stylegan_v010_1_256_relight_10k_rmix30k_30k_onlynonfront,
# stylegan_v010_3_256_relight_20k_rmix30k_30k_mix

# stylegan_v010_3_256_relight_50k_70kffhq,
# stylegan_v010_3_256_relight_50k_rmix50k_50k
#     end2end models
stylegan_end2end_relight_50k_rmix50k_50k,
    stylegan_end2end_relight_50k_rmix50k_50k,
    end2end_50k_031_256_rmix50k_D2_data_70kFFHQ

#     0.5.2
# model_lab_stylegan_052_256_10k_neut_ambcolor_pcrop,model_lab_stylegan_052_256_30k_neut_pcrop,model_lab_stylegan_052_256_30k_neut_pcrop_rmix30k,
# model_512_10k_lab_031_30ksgan_30kffhq,
#     model_512_30k_lab_031_30ksgan_30kffhq,
    # model_512_lab_stylegan_052_30k_r70kffhq_neutral_noprops_pcrop,
# model_512_lab_stylegan_052_20k_r30k_30k_neutral_noprops_pcrop
# model_512_lab_stylegan_052_30k_r30kffhq_30ksgan_neutral_noprops_pcrop

# model_lab_stylegan_031_256_10k_neut_noamb_pcrop,
# model_lab_stylegan_031_256_10k_neutral_sideoffset_60ksgan_60kffhq,
# model_lab_stylegan_031_256_10k_neutral_sideoffset_70kffhq_LchannelLoss
...
#     model_lab_stylegan_031_256_10k_neut_facetone_pcrop_70k_70k,
# model_lab_stylegan_031_256_30k_neut_facetone_pcrop_30k_30k
    # model_lab_stylegan_031_256_10k_neut_facetone_pcrop_reproducible
    # model_lab_stylegan_051_256_10k_neut_sundiam_ambcolor_pcrop_ep11,
    # model_lab_stylegan_051_256_10k_neut_sundiam_ambcolor_pcrop_ep12,
    # model_lab_stylegan_051_256_10k_neut_sundiam_ambcolor_pcrop_ep13,
    # model_lab_stylegan_051_256_10k_neut_sundiam_ambcolor_pcrop,
    ...
    # model_lab_stylegan_051_256_10k_neut_sundiam_bs60_pcrop_run2_ep11,
    # model_lab_stylegan_051_256_10k_neut_sundiam_bs60_pcrop_run2_ep12,
    # model_lab_stylegan_051_256_10k_neut_sundiam_bs60_pcrop_run2_ep13,
    # model_lab_stylegan_051_256_10k_neut_sundiam_bs60_pcrop_run2,
...
def load_model(checkpoint_dir_cmd, device, input_mode='L', model_1024=False, model_neutral=False, enable_ambient=False,
    ...
    if input_mode in ['L', 'LAB']:
        ...
        if model_1024:
            ...
            # print(nc_light_extra,nc_sh)
            my_network = HourglassNet(enable_target=not model_neutral, ncImg=nc_img, ncLightExtra=nc_light_extra, ncLight=9*nc_sh)
            end2end=True
            if end2end:
                netG1 = HourglassNet(enable_target=False, ncImg=nc_img, ncLightExtra=nc_light_extra)
                netG2 = HourglassNet(enable_target=True, ncImg=nc_img, ncLightExtra=nc_light_extra)
    else:
    ...
    if end2end:
        a=0
        print('LOADING',checkpoint_dir_cmd)
        loaded_params1 = torch.load(checkpoint_dir_cmd)
        netG1.load_state_dict(loaded_params1)
        netG1.to(device)
        netG1.train(False)

        print('Loading',checkpoint_dir_cmd.replace('G1','G2'))
        loaded_params2 = torch.load(checkpoint_dir_cmd.replace('G1','G2'))
        netG2.load_state_dict(loaded_params2)
        netG2.to(device)
        netG2.train(False)
        # return [netG1, netG2]
        return [netG1, netG2]
...
def test(my_network, input_img, sh_id=0, sh_constant=1.0, res=256, sh_path=lightFolder_3dulight, sh_fname=None, extra_ops={}, intensity=None):
    ...
    sh = sh * sh_constant
    sh_og = np.copy(sh)
    sh = np.append(sh,([1.0]),axis=0)
    sh = np.append(sh,([1.0]),axis=0)
    sh = np.append(sh,([1.0]),axis=0)

    # sh = np.copy(sh_extended)
    ...
    normal_one = False
    if normal_one:
        sh = np.reshape(sh, (1, 12, 1, 1)).astype(np.float32)
        output_img, output_sh = my_network(img, sh, 0, **extra_ops)
    else:
        # print(sh.shape)
        sh = np.reshape(sh, (1, 12, 1, 1)).astype(np.float32)
        print(osp.join(sh_path, sh_fname))
        print('input sh for the network::', sh)
        end2end=True
        if end2end:
            # output image of neutral goes to relight

            sh = np.squeeze(sh_og)
            sh = np.reshape(sh, (1, 9, 1, 1)).astype(np.float32)
            print(my_network)
            output_img, output_sh = my_network(img, sh, 0, **extra_ops)
            # output_img, output_sh = my_network(output_img, sh, 0, **extra_ops)
        else:

            output_img, output_sh = my_network(img, sh, 0, **extra_ops)

            print(sh)
            print('output from the network::', output_sh)

            output_sh_np = output_sh[0].cpu().data.numpy()  # [9:]


            sh = np.copy(sh_og)
            sh = np.append(sh, (output_sh_np[9][0]), axis=0)
            sh = np.append(sh, (output_sh_np[10][0]), axis=0)
            sh = np.append(sh, (output_sh_np[11][0]), axis=0)
            # from time import sleep
            # sleep(100)
            sh = np.reshape(sh, (1, 12, 1, 1)).astype(np.float32)

            print('input back to the networ',sh)
            output_img, output_sh = my_network(img, sh, 0, **extra_ops)
...
for model_obj in model_objs:
    ...
    model_obj.model = load_model(model_obj.checkpoint_path, model_obj.device, input_mode=model_obj.input_mode,
                                 ...
                                 enable_face_tone=model_obj.enable_face_tone)#[0]
...
for orig_path, out_fname, gt_data in dataset.iterate():
    ...
    for sh_idx in range(min_sh_list_len):
        ...
        for model_obj in model_objs:
            ...
            if len(result_img)>1:
                result_img_neutral = handle_output(result_img[0], orig_img_proc.shape[1], orig_img_proc.shape[0], mask, orig_img_proc, orig_img, loc, crop_sz, border, enable_face_boxes, orig_path.rsplit('/', 1)[-1].rsplit('.', 1)[0], target_sh, sh, model_obj.blend_mode)
                result_img_rel = handle_output(result_img[1], orig_img_proc.shape[1], orig_img_proc.shape[0], mask, orig_img_proc, orig_img, loc, crop_sz, border, enable_face_boxes, orig_path.rsplit('/', 1)[-1].rsplit('.', 1)[0], target_sh, sh, model_obj.blend_mode)
                result_img = [result_img_neutral,result_img_rel]
            ...
            if len(result_img) > 1:
                if result_img[0].shape[0]>min_resolution:
                    result_img[0] = resize_pil(result_img[0], height=min_resolution)
                    result_img[1] = resize_pil(result_img[1], height=min_resolution)
            else:
                if result_img.shape[0]>min_resolution:
                    result_img = resize_pil(result_img, height=min_resolution)

            if len(result_img) > 1:
                result_img[0] = np.ascontiguousarray(result_img[0], dtype=np.uint8)
                result_img[1] = np.ascontiguousarray(result_img[1], dtype=np.uint8)
            else:
            ...
            if not enable_test_mode:
                if len(result_img) > 1:
                    result_img[0] = draw_label(result_img[0], 'G1, neutral')
                    result_img[1] = draw_label(result_img[1], model_obj.name)
                else:
                    result_img = draw_label(result_img, model_obj.name)
            if len(result_img) > 1:
                results_frame.append(result_img[0])
                results_frame.append(result_img[1])
            else:
